...
$name=array();
$table = urldecode($end_array['table']);
...
$branch = urldecode($end_array['branch']);
$year = urldecode($end_array['year']);
echo $name;
// fwrite($fp, $name);
// fclose($fp);
...
$sql = "Insert into ".$table." values('".$email."','".$name."','".$phone."','".$college."','".$branch."','".$year."');";
// echo $sql;
